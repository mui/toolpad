import { NodeId, LiveBindings, ScopeMeta, ApplicationVm } from '@mui/toolpad-studio-core';
import * as React from 'react';
import { update, updateOrCreate } from '@mui/toolpad-studio-utils/immutability';
