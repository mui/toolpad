...
function useStorageStateServer(kind, key, initializer = null) {
  const [initialValue] = React7__namespace.useState(initializer);
  return [initialValue, () => {
  }];
}
function useStorageStateBrowser(kind, key, initializer = null) {
  ...
  const subscribeKey = React7__namespace.useCallback((cb) => subscribe(area, key, cb), [area, key]);
  const getKeySnapshot = React7__namespace.useCallback(
    () => getSnapshot(area, key) ?? initialValue,
    [area, initialValue, key]
  );
  const getKeyServerSnapshot = React7__namespace.useCallback(() => initialValue, [initialValue]);
  const storedValue = React7__namespace.useSyncExternalStore(
    subscribeKey,
    getKeySnapshot,
    getKeyServerSnapshot
  );
  const setStoredValue = React7__namespace.useCallback(
    (value) => {
...
function JsonPointerInput({
  ...
  const options = React7__namespace.useMemo(
  ...
  return /* @__PURE__ */ React7__namespace.createElement(
    material.Autocomplete,
    {
      ...
      renderInput: (params) => /* @__PURE__ */ React7__namespace.createElement(material.TextField, { ...props, ...params })
    }
  );
}
...
var ProbeContext = React7__namespace.createContext(null);
function useProbeTarget(key, value) {
  const probeContext = React7__namespace.useContext(ProbeContext);
  React7__namespace.useEffect(() => {
    update(key, value);
  }, [probeContext, key, value]);
}
function useProbe(key) {
  const subscribeKey = React7__namespace.useCallback((cb) => subscribe2(key, cb), [key]);
  const getKeySnapshot = React7__namespace.useCallback(() => getSnapshot2(key), [key]);
  return React7__namespace.useSyncExternalStore(subscribeKey, getKeySnapshot);
}
function useProbes() {
  return React7__namespace.useContext(ProbeContext);
}
...
function ColumnDefinitionEditor({
  ...
  const fieldSuggestions = React7__namespace.useMemo(() => {
  ...
  return /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, /* @__PURE__ */ React7__namespace.createElement(
    material.Autocomplete,
    {
      freeSolo: true,
      ...
      renderInput: (params) => /* @__PURE__ */ React7__namespace.createElement(material.TextField, { ...params, label: "Field" })
    }
    ...
    JsonPointerInput,
    {
      ...
      helperText: /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, "Valid ", /* @__PURE__ */ React7__namespace.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the returned row.")
    }
  ), /* @__PURE__ */ React7__namespace.createElement(
    material.TextField,
    {
    ...
    Object.keys(COLUMN_TYPE_OPTIONS).map((type) => /* @__PURE__ */ React7__namespace.createElement(material.MenuItem, { key: type, value: type }, getTypeLabel(type)))
  ), /* @__PURE__ */ React7__namespace.createElement(material.Button, { color: "error", startIcon: /* @__PURE__ */ React7__namespace.createElement(DeleteIcon__default.default, null), onClick: () => onDelete?.() }, "Remove column"));
}
function ColumnsDefinitionsEditor({ value, onChange }) {
  const [activeIndex, setActiveIndex] = React7__namespace.useState(0);
  const activeColumn = React7__namespace.useMemo(() => value[activeIndex], [activeIndex, value]);
  return /* @__PURE__ */ React7__namespace.createElement(material.Stack, { direction: "row", sx: { width: "100%", height: "100%" } }, /* @__PURE__ */ React7__namespace.createElement(material.Stack, { direction: "column", sx: { width: "25%" } }, /* @__PURE__ */ React7__namespace.createElement(
    material.Box,
    {
      sx: {
        display: "flex",
    ...
    /* @__PURE__ */ React7__namespace.createElement(
      ...
      {
        fullWidth: true,
        endAdornment: /* @__PURE__ */ React7__namespace.createElement(material.InputAdornment, { position: "end" }, /* @__PURE__ */ React7__namespace.createElement(SearchIcon__default.default, null))
      }
    ),
    /* @__PURE__ */ React7__namespace.createElement(
      material.IconButton,
      ...
      /* @__PURE__ */ React7__namespace.createElement(AddIcon__default.default, null)
    )
  ), /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { overflow: "auto" } }, /* @__PURE__ */ React7__namespace.createElement(material.List, null, value.map((column, i) => {
    return /* @__PURE__ */ React7__namespace.createElement(material.ListItem, { key: column.field, disablePadding: true }, /* @__PURE__ */ React7__namespace.createElement(material.ListItemButton, { selected: activeIndex === i, onClick: () => setActiveIndex(i) }, /* @__PURE__ */ React7__namespace.createElement(material.ListItemText, { secondary: getTypeLabel(column.type) }, column.field)));
  })))), /* @__PURE__ */ React7__namespace.createElement(material.Stack, { sx: { p: 2 } }, activeColumn ? /* @__PURE__ */ React7__namespace.createElement(
...
function ColumnsEditor({ value, onChange }) {
  return /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { width: "100%", height: "100%" } }, /* @__PURE__ */ React7__namespace.createElement(
...
function useDebouncedHandler(fn, delay) {
  const fnRef = React7__namespace.useRef(fn);
  React7__namespace.useEffect(() => {
    fnRef.current = fn;
  }, [fn]);
  const delayedInvocation = React7__namespace.useRef(null);
  React7__namespace.useEffect(() => {
    if (!delayedInvocation.current) {
      return;
    }
  ...
  return React7__namespace.useCallback(
    (...params) => {
      clear(delayedInvocation);
...
function PropertyEditor({ providerSelectorInput, renderRowIdSelectorInput }) {
  ...
  return /* @__PURE__ */ React7__namespace.createElement(material.Stack, { sx: { width: "100%", height: "100%" }, direction: "row" }, /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { flex: 1, p: 2 } }, providerSelectorInput, renderRowIdSelectorInput({ target: liveRows?.[0] }), /* @__PURE__ */ React7__namespace.createElement(material.Typography, null, "Pass the data through a ", /* @__PURE__ */ React7__namespace.createElement("code", null, "rows"), " property on your component.")), /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { flex: 1 } }, "right"));
}
function useDebouncedInput(value, onChange, delay) {
  const [input, setInput] = React7__namespace.useState(value);
  React7__namespace.useEffect(() => {
    setInput(value);
  }, [value]);
  const debouncedOnChange = useDebouncedHandler(onChange, delay);
  const handleInputChange = React7__namespace.useCallback(
    (newValue) => {
      setInput(newValue);
...
function FetchEditor({
  ...
  return /* @__PURE__ */ React7__namespace.createElement(material.Stack, { sx: { width: "100%", height: "100%" }, direction: "row" }, /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { flex: 1, height: "100%", p: 2, overflow: "auto" } }, providerSelectorInput, /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, /* @__PURE__ */ React7__namespace.createElement(material.Stack, { direction: "row", sx: { gap: 1 } }, /* @__PURE__ */ React7__namespace.createElement(
    material.TextField,
    {
      select: true,
      sx: { width: "110px" },
    ...
    FETCH_METHOD_OPTIONS.map((option) => /* @__PURE__ */ React7__namespace.createElement(material.MenuItem, { key: option, value: option }, option))
  ), /* @__PURE__ */ React7__namespace.createElement(
    material.TextField,
    {
      label: "URL",
    ...
    JsonPointerInput,
    {
      ...
      helperText: /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, "Valid ", /* @__PURE__ */ React7__namespace.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the returned data that represents the rows.")
    }
  ), renderRowIdSelectorInput({ target: liveRows?.[0] }))), /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { flex: 1, height: "100%", overflow: "auto", px: 4 } }, /* @__PURE__ */ React7__namespace.createElement("pre", null, typeof liveRows === "undefined" ? "undefined" : JSON.stringify(liveRows, null, 2))));
}
function RowsSpecEditor({ value, onChange, renderRowIdSelectorInput }) {
  const providerSelectorInput = /* @__PURE__ */ React7__namespace.createElement(
    material.TextField,
    {
      select: true,
    ...
    DATA_KIND_OPTIONS.map((option) => /* @__PURE__ */ React7__namespace.createElement(material.MenuItem, { key: option.value, value: option.value }, option.label))
  );
  switch (value.kind) {
    case "property":
      return /* @__PURE__ */ React7__namespace.createElement(
...
function RowsEditor({ value, onChange }) {
  const renderRowIdSelectorInput = ({ target } = {}) => /* @__PURE__ */ React7__namespace.createElement(
    JsonPointerInput,
    {
      ...
      target,
      helperText: /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, "Valid ", /* @__PURE__ */ React7__namespace.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the rows, to be used as a unique identifier.")
    }
  );
  return /* @__PURE__ */ React7__namespace.createElement(
    RowsSpecEditor,
...
function NumberField({ value, onChange, onBlur, ...props }) {
  ...
  const clearEventRef = React7__namespace.useRef(null);
  ...
  const handleBlur = React7__namespace.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React7__namespace.createElement(material.TextField, { type: "number", value: input, onChange: handleChange, onBlur: handleBlur, ...props });
}
...
function DataGridFileEditor({
  ...
  const handleSpecChange = React7__namespace.useCallback(
    (newSpec) => {
  ...
  return /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { width: "100%", height: "100%", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React7__namespace.createElement(lab.TabContext, { value: activeTab }, /* @__PURE__ */ React7__namespace.createElement(
    material.Box,
    {
      sx: {
        borderBottom: 1,
    ...
    /* @__PURE__ */ React7__namespace.createElement(lab.TabList, { onChange: (_event, newValue) => setActiveTab(newValue) }, /* @__PURE__ */ React7__namespace.createElement(material.Tab, { label: "General", value: "general" }), /* @__PURE__ */ React7__namespace.createElement(material.Tab, { label: "Rows", value: "rows" }), /* @__PURE__ */ React7__namespace.createElement(material.Tab, { label: "Columns", value: "columns" }), /* @__PURE__ */ React7__namespace.createElement(material.Tab, { label: "Source", value: "source" })),
    commitButton
  ), /* @__PURE__ */ React7__namespace.createElement(TabPanel, { value: "general" }, /* @__PURE__ */ React7__namespace.createElement(material.Container, null, /* @__PURE__ */ React7__namespace.createElement(material.Box, null, /* @__PURE__ */ React7__namespace.createElement(material.FormControl, null, /* @__PURE__ */ React7__namespace.createElement(material.FormLabel, null, "Data Grid Height"), /* @__PURE__ */ React7__namespace.createElement(
    material.RadioGroup,
    {
      value: heightMode,
    ...
    /* @__PURE__ */ React7__namespace.createElement(material.FormControlLabel, { value: "auto", control: /* @__PURE__ */ React7__namespace.createElement(material.Radio, null), label: "Auto height" }),
    /* @__PURE__ */ React7__namespace.createElement(
      material.FormControlLabel,
      {
        value: "container",
        control: /* @__PURE__ */ React7__namespace.createElement(material.Radio, null),
        label: "Adapt height to container"
      }
    ),
    /* @__PURE__ */ React7__namespace.createElement(material.FormControlLabel, { value: "fixed", control: /* @__PURE__ */ React7__namespace.createElement(material.Radio, null), label: "Fixed height" })
  ))), /* @__PURE__ */ React7__namespace.createElement(material.Box, null, /* @__PURE__ */ React7__namespace.createElement(
    NumberField,
    {
      label: "height",
  ...
  )))), /* @__PURE__ */ React7__namespace.createElement(TabPanel, { value: "rows" }, /* @__PURE__ */ React7__namespace.createElement(RowsEditor, { value: value.spec || {}, onChange: handleSpecChange })), /* @__PURE__ */ React7__namespace.createElement(TabPanel, { value: "columns" }, /* @__PURE__ */ React7__namespace.createElement(ColumnsEditor, { value: value.spec ?? {}, onChange: handleSpecChange })), /* @__PURE__ */ React7__namespace.createElement(TabPanel, { value: "source" }, /* @__PURE__ */ React7__namespace.createElement(material.Container, { sx: { width: "100%", height: "100%", overflow: "auto", px: 4 } }, source ? source.files.map(([path5, { code }]) => /* @__PURE__ */ React7__namespace.createElement(material.Box, { key: path5 }, /* @__PURE__ */ React7__namespace.createElement(material.Typography, { variant: "h6" }, path5), /* @__PURE__ */ React7__namespace.createElement("pre", null, code))) : null))));
}
...
var ServerContext = React7__namespace.createContext(null);
function ServerProvider({ wsUrl, children }) {
  const [client, setClient] = React7__namespace.useState(null);
  const [connectionStatus, setConnectionStatus] = React7__namespace.useState("connecting");
  React7__namespace.useEffect(() => {
  ...
  const context = React7__namespace.useMemo(() => {
    return {
      connectionStatus,
      saveFile(name, file) {
  ...
  return /* @__PURE__ */ React7__namespace.createElement(ServerContext.Provider, { value: context }, children);
}
function useServer() {
  const server = React7__namespace.useContext(ServerContext);
...
function ResizeHandle({ onResize, onCommitResize }) {
  const prevSize = React7__namespace.useRef(null);
  const [resizing, setResizing] = React7__namespace.useState(false);
  React7__namespace.useEffect(() => {
...
function DevtoolHost({ children }) {
  const rootRef = React7__namespace.useRef(null);
  const [height, setHeight] = React7__namespace.useState(() => window.innerHeight / 2);
  const handleResize = (y) => {
    setHeight((prevHeight) => prevHeight - y);
  };
  return /* @__PURE__ */ React7__namespace.createElement(material.Portal, null, /* @__PURE__ */ React7__namespace.createElement(material.ThemeProvider, { theme: theme_default }, /* @__PURE__ */ React7__namespace.createElement(material.ScopedCssBaseline, null, /* @__PURE__ */ React7__namespace.createElement(
    material.Box,
    {
      ref: rootRef,
      className: "mui-fixed",
    ...
    /* @__PURE__ */ React7__namespace.createElement(material.GlobalStyles, { styles: { body: { marginBottom: `${height}px` } } }),
    /* @__PURE__ */ React7__namespace.createElement(ResizeHandle, { onResize: handleResize }),
    /* @__PURE__ */ React7__namespace.createElement(
      material.Box,
      {
        sx: {
...
function FileEditor({ commitButton, value, onChange, source }) {
  switch (value.kind) {
    ...
    default:
      return /* @__PURE__ */ React7__namespace.createElement(material.Typography, null, "Unknown file: ", value.kind);
  }
}
...
function DevtoolOverlay({
  ...
  const rootRef = React7__namespace.useRef(null);
  const name = getComponentNameFromInputFile(filePath);
  const [inputValue, setInputValue] = React7__namespace.useState(file);
  const { connectionStatus } = useServer();
  const [source, setSource] = React7__namespace.useState(void 0);
  React7__namespace.useEffect(() => {
    const outDir = "/";
  ...
  const commitButton = /* @__PURE__ */ React7__namespace.createElement(material.Tooltip, { title: "Commit changes" }, /* @__PURE__ */ React7__namespace.createElement(
    material.IconButton,
    {
      sx: { m: 0.5 },
      onClick: () => {
    ...
    /* @__PURE__ */ React7__namespace.createElement(SaveIcon__default.default, null)
  ));
  return /* @__PURE__ */ React7__namespace.createElement(material.ThemeProvider, { theme: theme_default }, /* @__PURE__ */ React7__namespace.createElement(DevtoolHost, null, /* @__PURE__ */ React7__namespace.createElement(
    material.Box,
    {
      ref: rootRef,
      sx: {
    ...
    /* @__PURE__ */ React7__namespace.createElement(
      ...
      /* @__PURE__ */ React7__namespace.createElement(material.Typography, null, name, " (", file.kind, ")"),
      /* @__PURE__ */ React7__namespace.createElement(
        material.Box,
        {
          sx: {
        ...
        /* @__PURE__ */ React7__namespace.createElement(
          ...
          /* @__PURE__ */ React7__namespace.createElement(material.Typography, null, "Status:"),
          /* @__PURE__ */ React7__namespace.createElement(
            material.Box,
            {
              sx: {
          ...
          /* @__PURE__ */ React7__namespace.createElement(material.Typography, null, CONNECTION_STATUS_DISPLAY[connectionStatus].label)
        ),
        /* @__PURE__ */ React7__namespace.createElement(material.IconButton, { size: "small", onClick: onClose }, /* @__PURE__ */ React7__namespace.createElement(CloseIcon__default.default, { fontSize: "inherit" }))
      )
    ),
    /* @__PURE__ */ React7__namespace.createElement(material.Box, { sx: { flex: 1, overflow: "hidden", position: "relative" } }, connectionStatus === "connected" ? /* @__PURE__ */ React7__namespace.createElement(
      FileEditor,
      {
        value: inputValue,
      ...
      connectionStatus === "disconnected" ? /* @__PURE__ */ React7__namespace.createElement(React7__namespace.Fragment, null, /* @__PURE__ */ React7__namespace.createElement(ErrorOutlineIcon__default.default, { color: "error" }), "Connection lost") : /* @__PURE__ */ React7__namespace.createElement(material.CircularProgress, null)
    ))
  )));
}
var CurrentComponentContext = React7__namespace.createContext(null);
...
function useCurrentlyEditedComponentId() {
  ...
  const handleEditedComponentIdChange = React7__namespace.useCallback(
    (value) => {
      reset();
...
function EditButton(props) {
  ...
  const componentInfo = React7__namespace.useContext(CurrentComponentContext);
  ...
  return /* @__PURE__ */ React7__namespace.createElement(
    material.Button,
    {
      ...
      startIcon: /* @__PURE__ */ React7__namespace.createElement(EditIcon__default.default, null)
    },
    "Edit"
  );
}
function withDevtool(Component, { filePath, file, wsUrl, dependencies }) {
  ...
  return function ComponentWithDevtool(props) {
    ...
    const [id] = React7__namespace.useState(() => {
      const newId = `component-${nextId}`;
      nextId += 1;
      return newId;
    });
    const editing = currentlyEditedComponentId === id;
    const componentInfo = React7__namespace.useMemo(() => {
      return { id, name, file, props };
    }, [id, props]);
    const [RenderedComponent, setRenderedComponent] = React7__namespace.useState(
      () => Component
    );
    const handleComponentUpdate = React7__namespace.useCallback((NewComponent) => {
    ...
    return /* @__PURE__ */ React7__namespace.createElement(CurrentComponentContext.Provider, { value: componentInfo }, editing ? /* @__PURE__ */ React7__namespace.createElement(ServerProvider, { wsUrl }, /* @__PURE__ */ React7__namespace.createElement(
      material.Box,
      {
        sx: {
          display: "contents",
      ...
      /* @__PURE__ */ React7__namespace.createElement(RenderedComponent, { ...props })
    ), /* @__PURE__ */ React7__namespace.createElement(
      DevtoolOverlay,
      {
        filePath,
