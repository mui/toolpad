  ...
  return [
    {
      ...
      source: 'https://github.com/mui/mui-toolpad/tree/master/examples/core-tutorial',
    },
    {
      ...
      source: 'https://github.com/mui/mui-toolpad/tree/master/examples/core-auth-nextjs',
    },
    {
      ...
      src: '/static/toolpad/docs/core/auth-next.png',
      source: 'https://github.com/mui/mui-toolpad/tree/master/examples/core-auth-nextjs-pages',
    },
  ];
}
