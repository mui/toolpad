...
If you are building a single-page application with React Router DOM for routing, the `AppProvider` exported from `@toolpad/core/react-router-dom` is probably the best fit.
