...
1. Select function datasource and click **CREATE QUERY**:
   ...
   <img src="/static/toolpad/function-query-1.png" alt="Function datasource" width="476px" />
...
1. In addition you are now presented with a **code editor** where you can write a custom code for data fetching:
   ...
   <img src="/static/toolpad/function-query-2.png" alt="Function configuration" width="888px" />
...
1. **Pre-processing** request:
   ...
   <img src="/static/toolpad/function-query-3.png" alt="Function pre-processing" width="790px" style="margin-bottom: 16px;" />

1. **Fetching** data from **multiple data sources** and **combining** the result:

   <img src="/static/toolpad/function-query-4.png" alt="Function combined result" width="814px" />
...
1. **Chaining** multiple request:
   ...
   <img src="/static/toolpad/function-query-5.png" alt="Function chained" width="944px" />
...
1. **Custom error handling**:
   ...
   <img src="/static/toolpad/function-query-6.png" alt="Function error handling" width="706px" />
