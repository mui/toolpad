...
`;
  ...
  return {
    ...
    viteConfig: {
      ...
      optimizeDeps: {
        include: [
          '@mui/toolpad > @emotion/cache',
          '@mui/toolpad > @emotion/react',
          '@mui/toolpad > @mui/icons-material',
          '@mui/toolpad > @mui/icons-material/ArrowDropDownRounded',
          '@mui/toolpad > @mui/icons-material/Close',
          '@mui/toolpad > @mui/icons-material/Delete',
          '@mui/toolpad > @mui/icons-material/DarkMode',
          '@mui/toolpad > @mui/icons-material/Edit',
          '@mui/toolpad > @mui/icons-material/Error',
          '@mui/toolpad > @mui/icons-material/HelpOutlined',
          '@mui/toolpad > @mui/icons-material/LightMode',
          '@mui/toolpad > @mui/icons-material/OpenInNew',
          '@mui/toolpad > @mui/icons-material/SettingsBrightnessOutlined',
          '@mui/toolpad > @mui/lab',
          '@mui/toolpad > @mui/material',
          '@mui/toolpad > @mui/material/CircularProgress',
          '@mui/toolpad > @mui/material/Button',
          '@mui/toolpad > @mui/material/colors',
          '@mui/toolpad > @mui/material/styles',
          '@mui/toolpad > @mui/material/useMediaQuery',
          '@mui/toolpad > @mui/utils',
          '@mui/toolpad > @mui/utils/useEventCallback',
          '@mui/toolpad > @mui/x-data-grid-pro',
          '@mui/toolpad > @mui/x-date-pickers/AdapterDayjs',
          '@mui/toolpad > @mui/x-date-pickers/DesktopDatePicker',
          ...
          '@mui/toolpad > dayjs/locale/nl',
          '@mui/toolpad > fractional-indexing',
          '@mui/toolpad > invariant',
          ...
          '@mui/toolpad > react',
          '@mui/toolpad > react/jsx-dev-runtime',
          '@mui/toolpad > react/jsx-runtime',
          '@mui/toolpad > react-dom',
          '@mui/toolpad > react-dom/client',
          '@mui/toolpad > react-error-boundary',
          '@mui/toolpad > react-hook-form',
          '@mui/toolpad > react-is',
          '@mui/toolpad > react-router-dom',
