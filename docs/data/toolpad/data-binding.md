...
<img src="/static/toolpad/docs/data-binding-1.png" alt="Binding icon" width="42px" />
...
<img src="/static/toolpad/docs/data-binding-2.png" alt="Binding example" width="230px" />
...
<img src="/static/toolpad/docs/data-binding-3.png" alt="Binding editor" width="889px" />
...
<img src="/static/toolpad/docs/data-binding-4.png" alt="Binding custom expression" width="887px" />
...
<img src="/static/toolpad/docs/data-binding-5.png" alt="Binding result 1" width="452px" style="margin-bottom: 8px;" />

Field with value:

<img src="/static/toolpad/docs/data-binding-6.png" alt="Binding result 2" width="453px" />
...
<img src="/static/toolpad/docs/data-binding-7.png" alt="Edit page module" width="138px" />

You will be presented with an editor where you can define any number of variables:

<img src="/static/toolpad/docs/data-binding-8.png" alt="Global scope" width="886px" />

Once you **SAVE** the changes you can use those variables to bind value of any property:

<img src="/static/toolpad/docs/data-binding-9.png" alt="Global variable in the editor" width="177px" />
