...
function Left({ menuIcon }) {
  return (
    <Stack direction="row" spacing={2} alignItems="center">
      {menuIcon}
      {/* put the AppTitle here if you want to use the title component */}
      {/* <AppTitle /> */}
    </Stack>
  );
}
...
function Right() {
  return (
    <Stack direction="row" spacing={2} alignItems="center">
      <CustomThemeSwitcher />
      {/* put the ToolbarActions here if you want to use the toolbar actions component */}
      {/* <ToolbarActions /> */}
      <Account />
...
export default function DashboardLayoutCustomToolbar(props) {
  const { window } = props;
