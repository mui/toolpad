  ...
  cards: [
    {
      ...
      wip: false,
      imageUrl: '/static/branding/toolpad-monitoring-dashboard.png',
      description:
    ...
    },
    {
      title: 'Admin panel',
      wip: false,
      imageUrl: '/static/branding/toolpad-admin-panel.png',
      description:
    ...
    },
    {
      title: 'Custom CMS',
      wip: false,
      imageUrl: '/static/branding/toolpad-custom-cms.png',
      description:
