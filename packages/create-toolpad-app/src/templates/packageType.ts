...
@category File
*/
export type PackageJson = PackageJsonTypes.NodeJsStandard &
  PackageJsonTypes.PackageJsonStandard &
  PackageJsonTypes.NonStandardEntryPoints &
  PackageJsonTypes.TypeScriptConfiguration &
  PackageJsonTypes.YarnConfiguration &
  PackageJsonTypes.JSPMConfiguration;
