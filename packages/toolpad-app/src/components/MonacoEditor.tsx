...
window.MonacoEnvironment = {
  async getWorker(_, label) {
    if (label === 'typescript') {
      return new Worker(new URL(`./monacoWorkers/ts`, import.meta.url));
    }
    if (label === 'json') {
      return new Worker(new URL(`./monacoWorkers/json`, import.meta.url));
    }
    if (label === 'html') {
      return new Worker(new URL(`./monacoWorkers/html`, import.meta.url));
    }
    if (label === 'css') {
      return new Worker(new URL(`./monacoWorkers/css`, import.meta.url));
    }
    if (label === 'editorWorkerService') {
      return new Worker(new URL('./monacoWorkers/editor', import.meta.url));
    }
