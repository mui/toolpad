...
function JsonPointerInput({
  ...
  return /* @__PURE__ */ React5.createElement(
    Autocomplete,
    {
      ...
      renderInput: (params) => /* @__PURE__ */ React5.createElement(TextField, { ...props, ...params })
    }
  );
}
...
var ProbeContext = React5.createContext(null);
function useProbeTarget(key, value) {
  const probeContext = React5.useContext(ProbeContext);
  React5.useEffect(() => {
    update(key, value);
  }, [probeContext, key, value]);
}
function useProbe(key) {
  const subscribeKey = React5.useCallback((cb) => subscribe(key, cb), [key]);
  const getKeySnapshot = React5.useCallback(() => getSnapshot(key), [key]);
  return React5.useSyncExternalStore(subscribeKey, getKeySnapshot);
}
function useProbes() {
  return React5.useContext(ProbeContext);
}
...
function ColumnDefinitionEditor({
  ...
  const fieldSuggestions = React5.useMemo(() => {
  ...
  return /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(
    Autocomplete,
    {
      ...
      renderInput: (params) => /* @__PURE__ */ React5.createElement(TextField, { ...params, label: "Field" })
    }
    ...
    JsonPointerInput,
    {
      ...
      helperText: /* @__PURE__ */ React5.createElement(React5.Fragment, null, "Valid ", /* @__PURE__ */ React5.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the returned row.")
    }
  ), /* @__PURE__ */ React5.createElement(
    TextField,
    {
    ...
    Object.keys(COLUMN_TYPE_OPTIONS).map((type) => /* @__PURE__ */ React5.createElement(MenuItem, { key: type, value: type }, getTypeLabel(type)))
  ), /* @__PURE__ */ React5.createElement(Button, { color: "error", startIcon: /* @__PURE__ */ React5.createElement(DeleteIcon, null), onClick: () => onDelete?.() }, "Remove column"));
}
function ColumnsDefinitionsEditor({ value, onChange }) {
  const [activeIndex, setActiveIndex] = React5.useState(0);
  const activeColumn = React5.useMemo(() => value[activeIndex], [activeIndex, value]);
  return /* @__PURE__ */ React5.createElement(Stack, { direction: "row", sx: { width: "100%", height: "100%" } }, /* @__PURE__ */ React5.createElement(Stack, { direction: "column", sx: { width: "25%" } }, /* @__PURE__ */ React5.createElement(
    Box,
    {
      sx: {
        display: "flex",
    ...
    /* @__PURE__ */ React5.createElement(
      ...
      {
        fullWidth: true,
        endAdornment: /* @__PURE__ */ React5.createElement(InputAdornment, { position: "end" }, /* @__PURE__ */ React5.createElement(SearchIcon, null))
      }
    ),
    /* @__PURE__ */ React5.createElement(
      IconButton,
      ...
      /* @__PURE__ */ React5.createElement(AddIcon, null)
    )
  ), /* @__PURE__ */ React5.createElement(Box, { sx: { overflow: "auto" } }, /* @__PURE__ */ React5.createElement(List, null, value.map((column, i) => {
    return /* @__PURE__ */ React5.createElement(ListItem, { key: column.field, disablePadding: true }, /* @__PURE__ */ React5.createElement(ListItemButton, { selected: activeIndex === i, onClick: () => setActiveIndex(i) }, /* @__PURE__ */ React5.createElement(ListItemText, { secondary: getTypeLabel(column.type) }, column.field)));
  })))), /* @__PURE__ */ React5.createElement(Stack, { sx: { p: 2 } }, activeColumn ? /* @__PURE__ */ React5.createElement(
...
function ColumnsEditor({ value, onChange }) {
  return /* @__PURE__ */ React5.createElement(Box, { sx: { width: "100%", height: "100%" } }, /* @__PURE__ */ React5.createElement(
...
function PropertyEditor({ providerSelectorInput, renderRowIdSelectorInput }) {
  ...
  return /* @__PURE__ */ React5.createElement(Stack, { sx: { width: "100%", height: "100%" }, direction: "row" }, /* @__PURE__ */ React5.createElement(Box, { sx: { flex: 1, p: 2 } }, providerSelectorInput, renderRowIdSelectorInput({ target: liveRows?.[0] }), /* @__PURE__ */ React5.createElement(Typography, null, "Pass the data through a ", /* @__PURE__ */ React5.createElement("code", null, "rows"), " property on your component.")), /* @__PURE__ */ React5.createElement(Box, { sx: { flex: 1 } }, "right"));
}
function useDebouncedInput(value, onChange, delay) {
  const [input, setInput] = React5.useState(value);
  React5.useEffect(() => {
    setInput(value);
  }, [value]);
...
function FetchEditor({
  ...
  return /* @__PURE__ */ React5.createElement(Stack, { sx: { width: "100%", height: "100%" }, direction: "row" }, /* @__PURE__ */ React5.createElement(Box, { sx: { flex: 1, height: "100%", p: 2, overflow: "auto" } }, providerSelectorInput, /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(Stack, { direction: "row", sx: { gap: 1 } }, /* @__PURE__ */ React5.createElement(
    TextField,
    {
      select: true,
      sx: { width: "110px" },
    ...
    FETCH_METHOD_OPTIONS.map((option) => /* @__PURE__ */ React5.createElement(MenuItem, { key: option, value: option }, option))
  ), /* @__PURE__ */ React5.createElement(
    TextField,
    {
      label: "URL",
    ...
    JsonPointerInput,
    {
      ...
      helperText: /* @__PURE__ */ React5.createElement(React5.Fragment, null, "Valid ", /* @__PURE__ */ React5.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the returned data that represents the rows.")
    }
  ), renderRowIdSelectorInput({ target: liveRows?.[0] }))), /* @__PURE__ */ React5.createElement(Box, { sx: { flex: 1, height: "100%", overflow: "auto", px: 4 } }, /* @__PURE__ */ React5.createElement("pre", null, typeof liveRows === "undefined" ? "undefined" : JSON.stringify(liveRows, null, 2))));
}
function RowsSpecEditor({ value, onChange, renderRowIdSelectorInput }) {
  const providerSelectorInput = /* @__PURE__ */ React5.createElement(
    TextField,
    {
      select: true,
    ...
    DATA_KIND_OPTIONS.map((option) => /* @__PURE__ */ React5.createElement(MenuItem, { key: option.value, value: option.value }, option.label))
  );
  switch (value.kind) {
    case "property":
      return /* @__PURE__ */ React5.createElement(
...
function RowsEditor({ value, onChange }) {
  const renderRowIdSelectorInput = ({ target } = {}) => /* @__PURE__ */ React5.createElement(
    JsonPointerInput,
    {
      ...
      target,
      helperText: /* @__PURE__ */ React5.createElement(React5.Fragment, null, "Valid ", /* @__PURE__ */ React5.createElement("a", { href: "https://datatracker.ietf.org/doc/html/rfc6901" }, "JSON Pointer"), " that references a (nested) property in the rows, to be used as a unique identifier.")
    }
  );
  return /* @__PURE__ */ React5.createElement(
    RowsSpecEditor,
...
function NumberField({ value, onChange, onBlur, ...props }) {
  ...
  const clearEventRef = React5.useRef(null);
  ...
  return /* @__PURE__ */ React5.createElement(TextField, { type: "number", value: input, onChange: handleChange, onBlur: handleBlur, ...props });
}
...
function DataGridFileEditor({
  ...
  const handleSpecChange = React5.useCallback(
    (newSpec) => {
  ...
  return /* @__PURE__ */ React5.createElement(Box, { sx: { width: "100%", height: "100%", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React5.createElement(TabContext, { value: activeTab }, /* @__PURE__ */ React5.createElement(
    Box,
    {
      sx: {
        borderBottom: 1,
    ...
    /* @__PURE__ */ React5.createElement(TabList, { onChange: (_event, newValue) => setActiveTab(newValue) }, /* @__PURE__ */ React5.createElement(Tab, { label: "General", value: "general" }), /* @__PURE__ */ React5.createElement(Tab, { label: "Rows", value: "rows" }), /* @__PURE__ */ React5.createElement(Tab, { label: "Columns", value: "columns" }), /* @__PURE__ */ React5.createElement(Tab, { label: "Source", value: "source" })),
    commitButton
  ), /* @__PURE__ */ React5.createElement(TabPanel, { value: "general" }, /* @__PURE__ */ React5.createElement(Container, null, /* @__PURE__ */ React5.createElement(Box, null, /* @__PURE__ */ React5.createElement(FormControl, null, /* @__PURE__ */ React5.createElement(FormLabel, null, "Data Grid Height"), /* @__PURE__ */ React5.createElement(
    RadioGroup,
    {
      value: heightMode,
    ...
    /* @__PURE__ */ React5.createElement(FormControlLabel, { value: "auto", control: /* @__PURE__ */ React5.createElement(Radio, null), label: "Auto height" }),
    /* @__PURE__ */ React5.createElement(
      FormControlLabel,
      {
        value: "container",
        control: /* @__PURE__ */ React5.createElement(Radio, null),
        label: "Adapt height to container"
      }
    ),
    /* @__PURE__ */ React5.createElement(FormControlLabel, { value: "fixed", control: /* @__PURE__ */ React5.createElement(Radio, null), label: "Fixed height" })
  ))), /* @__PURE__ */ React5.createElement(Box, null, /* @__PURE__ */ React5.createElement(
    NumberField,
    {
      label: "height",
  ...
  )))), /* @__PURE__ */ React5.createElement(TabPanel, { value: "rows" }, /* @__PURE__ */ React5.createElement(RowsEditor, { value: value.spec || {}, onChange: handleSpecChange })), /* @__PURE__ */ React5.createElement(TabPanel, { value: "columns" }, /* @__PURE__ */ React5.createElement(ColumnsEditor, { value: value.spec ?? {}, onChange: handleSpecChange })), /* @__PURE__ */ React5.createElement(TabPanel, { value: "source" }, /* @__PURE__ */ React5.createElement(Container, { sx: { width: "100%", height: "100%", overflow: "auto", px: 4 } }, source ? source.files.map(([path5, { code }]) => /* @__PURE__ */ React5.createElement(Box, { key: path5 }, /* @__PURE__ */ React5.createElement(Typography, { variant: "h6" }, path5), /* @__PURE__ */ React5.createElement("pre", null, code))) : null))));
}
...
var ServerContext = React5.createContext(null);
function ServerProvider({ wsUrl, children }) {
  const [client, setClient] = React5.useState(null);
  const [connectionStatus, setConnectionStatus] = React5.useState("connecting");
  React5.useEffect(() => {
  ...
  return /* @__PURE__ */ React5.createElement(ServerContext.Provider, { value: context }, children);
}
function useServer() {
  const server = React5.useContext(ServerContext);
...
function ResizeHandle({ onResize, onCommitResize }) {
  const prevSize = React5.useRef(null);
  const [resizing, setResizing] = React5.useState(false);
  React5.useEffect(() => {
...
function DevtoolHost({ children }) {
  ...
  const [height, setHeight] = React5.useState(() => window.innerHeight / 2);
  const handleResize = (y) => {
    setHeight((prevHeight) => prevHeight - y);
  };
  return /* @__PURE__ */ React5.createElement(Portal, null, /* @__PURE__ */ React5.createElement(ThemeProvider, { theme: theme_default }, /* @__PURE__ */ React5.createElement(ScopedCssBaseline, null, /* @__PURE__ */ React5.createElement(
    Box,
    {
      ref: rootRef,
      className: "mui-fixed",
    ...
    /* @__PURE__ */ React5.createElement(GlobalStyles, { styles: { body: { marginBottom: `${height}px` } } }),
    /* @__PURE__ */ React5.createElement(ResizeHandle, { onResize: handleResize }),
    /* @__PURE__ */ React5.createElement(
      Box,
      {
        sx: {
...
function FileEditor({ commitButton, value, onChange, source }) {
  switch (value.kind) {
    ...
    default:
      return /* @__PURE__ */ React5.createElement(Typography, null, "Unknown file: ", value.kind);
  }
}
...
function DevtoolOverlay({
  ...
  const rootRef = React5.useRef(null);
  const name = getComponentNameFromInputFile(filePath);
  const [inputValue, setInputValue] = React5.useState(file);
  const { connectionStatus } = useServer();
  const [source, setSource] = React5.useState(void 0);
  React5.useEffect(() => {
    const outDir = "/";
  ...
  const commitButton = /* @__PURE__ */ React5.createElement(Tooltip, { title: "Commit changes" }, /* @__PURE__ */ React5.createElement(
    IconButton,
    {
      sx: { m: 0.5 },
      onClick: () => {
    ...
    /* @__PURE__ */ React5.createElement(SaveIcon, null)
  ));
  return /* @__PURE__ */ React5.createElement(ThemeProvider, { theme: theme_default }, /* @__PURE__ */ React5.createElement(DevtoolHost, null, /* @__PURE__ */ React5.createElement(
    Box,
    {
      ref: rootRef,
      sx: {
    ...
    /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(Typography, null, name, " (", file.kind, ")"),
      /* @__PURE__ */ React5.createElement(
        Box,
        {
          sx: {
        ...
        /* @__PURE__ */ React5.createElement(
          ...
          /* @__PURE__ */ React5.createElement(Typography, null, "Status:"),
          /* @__PURE__ */ React5.createElement(
            Box,
            {
              sx: {
          ...
          /* @__PURE__ */ React5.createElement(Typography, null, CONNECTION_STATUS_DISPLAY[connectionStatus].label)
        ),
        /* @__PURE__ */ React5.createElement(IconButton, { size: "small", onClick: onClose }, /* @__PURE__ */ React5.createElement(CloseIcon, { fontSize: "inherit" }))
      )
    ),
    /* @__PURE__ */ React5.createElement(Box, { sx: { flex: 1, overflow: "hidden", position: "relative" } }, connectionStatus === "connected" ? /* @__PURE__ */ React5.createElement(
      FileEditor,
      {
        value: inputValue,
      ...
      connectionStatus === "disconnected" ? /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(ErrorOutlineIcon, { color: "error" }), "Connection lost") : /* @__PURE__ */ React5.createElement(CircularProgress, null)
    ))
  )));
}
var CurrentComponentContext = React5.createContext(null);
...
function useCurrentlyEditedComponentId() {
  ...
  const handleEditedComponentIdChange = React5.useCallback(
    (value) => {
      reset();
...
function EditButton(props) {
  ...
  const componentInfo = React5.useContext(CurrentComponentContext);
  ...
  return /* @__PURE__ */ React5.createElement(
    Button,
    {
      ...
      startIcon: /* @__PURE__ */ React5.createElement(EditIcon, null)
    },
    "Edit"
  );
}
function withDevtool(Component, { filePath, file, wsUrl, dependencies }) {
  ...
  return function ComponentWithDevtool(props) {
    ...
    const componentInfo = React5.useMemo(() => {
      return { id, name, file, props };
    }, [id, props]);
    const [RenderedComponent, setRenderedComponent] = React5.useState(
      () => Component
    );
    const handleComponentUpdate = React5.useCallback((NewComponent) => {
    ...
    return /* @__PURE__ */ React5.createElement(CurrentComponentContext.Provider, { value: componentInfo }, editing ? /* @__PURE__ */ React5.createElement(ServerProvider, { wsUrl }, /* @__PURE__ */ React5.createElement(
      Box,
      {
        sx: {
          display: "contents",
      ...
      /* @__PURE__ */ React5.createElement(RenderedComponent, { ...props })
    ), /* @__PURE__ */ React5.createElement(
      DevtoolOverlay,
      {
        filePath,
